...
#        (cd ~/projects/lpub3d && env PRE=1 ../build_commit.sh)
#        (cd ~/projects/lpub3d && env BRANCH=MSYS2_BUILDS ../build_commit.sh)
#        (cd ~/projects/lpub3d && env COMMIT="LPub3D continuous development" ../build_commit.sh)
#        (cd ~/projects/lpub3d && env BRANCH=MSYS2_BUILDS COMMIT="LPub3D continuous development" ../build_commit.sh)
